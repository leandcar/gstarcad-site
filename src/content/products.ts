...
export const PRODUCTS: Product[] = [
  {
    ...
    badge: 'Mais vendido',
    featured: true,
    image: '/media/produtos/gstarcad-2027-pro.webp',
    icon: '◆',
    order: 3,
  },
  {
  ...
  },
  {
    ...
    licenses: ['Licença perpétua', 'Assinatura anual', 'Individual ou em rede'],
    featured: true,
    image: '/media/produtos/gstarcad-2027-std.webp',
    icon: '◇',
    order: 2,
  },
  {
    slug: 'gstarcad-2027-lt',
    ...
    image: '/media/produtos/gstarcad-2027-lt.webp',
    featured: true,
    icon: '○',
    order: 1,
  },
  {
    slug: 'gstarcad-2027-plus',
    ...
    image: '/media/produtos/gstarcad-2027-plus.webp',
    featured: true,
    icon: '◈',
    order: 4,
  },
